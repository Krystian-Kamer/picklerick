      ...
      <div className='w-full bg-gradient-to-r from-lime-200 to-lime-400'>
        ...
        <article className='flex flex-col max-w-7xl mx-auto justify-center py-16'>
          ...
          <div className='bg-slate-900 flex flex-col md:flex-row p-10 sm:m-6 sm:rounded-3xl mt-5 text-white text-2xl'>
            <img src={image} alt={name} className='max-h-96 object-cover' />
            <div className='px-4'>
        ...
        <div className='flex items-center justify-center gap-10 mb-20'>
          {id > 1 && (
            <Link
              to={`/characters/${id - 1}`}
              className='flex items-center py-2 px-4 sm:px-2 lg:px-4 w-fit  sm:gap-x-1 bg-slate-900 text-lime-200 rounded-3xl sm:rounded-xl lg:rounded-3xl hover:scale-105 duration-500 uppercase'
            >
              <GrFormPrevious className='w-14 h-14 sm:w-8 sm:h-8 lg:w-12 lg:h-12' />
          ...
          {id < totalCharacters && (
            ...
            >
              ...
              <GrFormNext className='w-14 h-14 sm:w-8 sm:h-8 lg:w-12 lg:h-12' />
            </Link>
          )}
        </div>
      </div>
